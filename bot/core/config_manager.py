...
class Config:
    AS_DOCUMENT = False
    AUTHORIZED_CHATS = "-1003816985891"
    ...
    CMD_SUFFIX = ""
    DEFAULT_LANG = "en"
    DATABASE_URL = "mongodb+srv://divyanshshukla5375_db_user:1kZ2dsVTktdMljpr@cluster0.lo5qk5v.mongodb.net/?appName=Cluster0"
    DEFAULT_UPLOAD = "rc"
    DELETE_LINKS = False
    DEBRID_LINK_API = ""
    ...
    FILELION_API = ""
    MEDIA_STORE = True
    FORCE_SUB_IDS = "-1003036774235,-1002026313336,-1002771780375"
    GOFILE_API = ""
    GOFILE_FOLDER_ID = ""
    PIXELDRAIN_KEY = ""
    PROTECTED_API = ""
    BUZZHEAVIER_API = ""
    GDRIVE_ID = "1JkL7BMqy91LEyHGrNnJN3kehMHoePVty"
    GD_DESP = "Uploaded with PiLeechBot"
    AUTHOR_NAME = "Bhanu Yadav"
    AUTHOR_URL = "https://t.me/Dev_Bhanu_Yadav"
    INSTADL_API = ""
    IMDB_TEMPLATE = ""
    ...
    JD_EMAIL = ""
    JD_PASS = ""
    MEGA_EMAIL = "saverestrictedcontent02@gmail.com"
    MEGA_PASSWORD = "divyansh54321"
    DIRECT_LIMIT = 0
    MEGA_LIMIT = 0
    TORRENT_LIMIT = 0
    GD_DL_LIMIT = 0
    ...
    WEB_PINCODE = True
    YT_DLP_OPTIONS = {}
    YT_DESP = "Uploaded with PiLeechBot"
