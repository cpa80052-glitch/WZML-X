...
from bot.helper.telegram_helper.force_sub import check_force_sub

@TgClient.bot.on_message(filters.all)
async def force_sub_all(client, message):
    if not await check_force_sub(client, message):
        return

@TgClient.bot.on_callback_query()
async def force_sub_callback(client, query):
    if not await check_force_sub(client, query.message):
        return
